...
namespace AvaliacaoTrends.Models
{
    ...
    public class Questionario
    {
        ...
        public Questionario (decimal idQuestionario,string nomeQuestionario, char tipoQuestionario, string linkInstrucao )
        {
            ...
            this.qst_ds_link_instrucoes = linkInstrucao;
        }
        public Questionario() { }
    }
}